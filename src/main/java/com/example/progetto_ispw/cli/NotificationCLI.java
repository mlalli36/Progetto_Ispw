    ...
    public void notificationMethod() {
        try {
            ...
            if (elements.isEmpty()) {
                ...
                System.out.println("Enter the number associated with the appointment you want to manage:");
                ...
                if (selectedNumber >= 1 && selectedNumber <= elements.size()) {
                    ...
                    // Ask user for action
                    System.out.println("Do you want to accept or reject this appointment? (a/r)");
                    ...
                    if (action.equals("a")) {
                        ...
                        System.out.println("Invalid action. Please enter 'a' to accept or 'r' to reject.");
                    }
